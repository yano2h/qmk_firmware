 ...
 * | LCTR |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ;  |   {  |   }  |  -   |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LAlt | CLock|LOWER | Lcmd | /  Space/       \Enter \  |RAlt  |RAISE |RShift| PDwn |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 *
 */
  ...
  //|------+-------+--------+--------+--------+------|  ===  |   |  ===  |--------+-------+--------+--------+--------+---------|
       KC_LALT, KC_CAPS, LT(_LOWER, KC_SPC), SPC(MOD_LGUI), KC_SPC   ,KC_ENT, SPC(MOD_RALT), LT(_RAISE, KC_SPC), KC_RSFT, KC_PGDN
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
